    ...
    'item':{
        ...
        'npc':{
            ...
            'attrs':[
                ...
                ('give',         'Give',                False, 'lnk', '', 'Giving'),
                # ('response0',    'Response',            False, 'say', '', 'A  response given to recieving an item'),
                # ('item0',        'Item',                False, 'obj', '', 'The name of the object this response will be for'),
                # ('success0',     'Success',             False, 'cbx', '', 'Will this be a success?'),
                # ('response1',    'Response',            False, 'say', '', 'A  response given to recieving an item'),
                # ('item1',        'Item',                False, 'obj', '', 'The name of the object this response will be for'),
                # ('success1',     'Success',             False, 'cbx', '', 'Will this be a success?'),
                # ('response2',    'Response',            False, 'say', '', 'A  response given to recieving an item'),
                # ('item2',        'Item',                False, 'obj', '', 'The name of the object this response will be for'),
                # ('success2',     'Success',             False, 'cbx', '', 'Will this be a success?'),
                # ('response3',    'Response',            False, 'say', '', 'A  response given to recieving an item'),
                # ('item3',        'Item',                False, 'obj', '', 'The name of the object this response will be for'),
                # ('success3',     'Success',             False, 'cbx', '', 'Will this be a success?'),
                # ('response4',    'Response',            False, 'say', '', 'A  response given to recieving an item'),
                # ('item4',        'Item',                False, 'obj', '', 'The name of the object this response will be for'),
                # ('success4',     'Success',             False, 'cbx', '', 'Will this be a success?'),
            ],
        },
